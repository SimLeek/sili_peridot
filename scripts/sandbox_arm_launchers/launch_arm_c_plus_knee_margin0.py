"""Same as launch_arm_c_plus_knee_skip_k1.py (Arm C backward + knee-
adaptive x_r_target forward, K_START=2, full historical-fix config)
but x_r_target_auto_margin=0.0 -- no safety margin above the raw
measured elbow, the other end of the calibration sweep from the
default (0.05) run already covered."""
...
print(
    "# ARM C + knee-adaptive x_r_target (margin=0.0), K_START=2, "
...
print("DONE_ARM_C_PLUS_KNEE_MARGIN0", flush=True)
