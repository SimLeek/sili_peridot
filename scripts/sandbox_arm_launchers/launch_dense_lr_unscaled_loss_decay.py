...
100k-step budget. Only intentional difference here: loss_adjusted_decay
enabled at its default calibration (importance-only,
...
specific config break through its own historical stall, everything else
held identical (same seed=1000, same architecture, same curriculum)."""
...
print(
    "# DENSE-UNSCALED + LOSS_ADJUSTED_DECAY (importance_half_life_touches=500, "
...
print("DONE_DENSE_LR_UNSCALED_LOSS_DECAY", flush=True)
