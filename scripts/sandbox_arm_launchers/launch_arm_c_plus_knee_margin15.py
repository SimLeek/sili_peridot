"""Same as launch_arm_c_plus_knee_skip_k1.py but
x_r_target_auto_margin=0.15 -- a larger safety margin above the raw
measured elbow than the default (0.05) run, completing the 3-point
{0.0, 0.05, 0.15} calibration sweep at full step budget."""
...
print(
    "# ARM C + knee-adaptive x_r_target (margin=0.15), K_START=2, "
...
print("DONE_ARM_C_PLUS_KNEE_MARGIN15", flush=True)
