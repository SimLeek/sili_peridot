"""Test 3 (2/4): same Arm C gate density (cutoff=0.0, ~50%) as
launch_armc_gatemid_lr_unscaled.py, but peak_lr=0.01 (the scaled value
that resolved the fully-dense backward arm's degeneracy at this width).
See that file's docstring for the full grid/question."""
...
print("DONE_ARMC_GATEMID_LR_SCALED", flush=True)
