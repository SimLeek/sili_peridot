"""Test 3 (3/4): sparser Arm C gate (cutoff=0.6, ~29.5% density --
sin(theta)>0.6 fraction) with peak_lr LEFT UNSCALED (0.015). See
launch_armc_gatemid_lr_unscaled.py's docstring for the full grid/
question: does a sparser gate tolerate the unscaled default LR where
the fully-dense backward arm couldn't."""
...
print("DONE_ARMC_GATESPARSE_LR_UNSCALED", flush=True)
