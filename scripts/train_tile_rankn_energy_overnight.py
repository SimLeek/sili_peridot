...
EMBED_WIDTH = 32
COLUMN_NEURONS = 32                       # state_width = 1024 -- near-full-scale, not toy
STATE_WIDTH = EMBED_WIDTH * COLUMN_NEURONS
MLP_HIDDEN = STATE_WIDTH * 2
NUM_TILES = 32                            # seq_len=32, matches largest existing tested variant
SEQ_LEN = NUM_TILES
NUM_KV_PAIRS = 4
VOCAB = 40
...
ENERGY_KWARGS = dict(drive=0.0535, activation_cost=0.05, precision=0.01,
                     density=0.05, p=0.95, reactivity=0.001)
