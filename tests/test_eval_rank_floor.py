...
class TestRankFloorRealModel:
    def test_disldo_vs_low_rank_vs_float32_at_scale_rank_2(self):
        ...
        fp4_det_layer = DISLDOLayerDeterministic(
            n, n, n * n, num_cpus=1, rng=np.random.default_rng(2001), dense=True, scale_rank=rank
        )
        ...
        fp4_stoch_layer = DISLDOLayer(
            n, n, n * n, num_cpus=1, rng=np.random.default_rng(2007), dense=True, scale_rank=rank
        )
        ...
        fp32_layer = DISLDOLayer32(n, n, n * n, num_cpus=1, rng=np.random.default_rng(2002))
