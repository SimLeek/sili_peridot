...
| 2026-09-18 | 288 (36) | ~351k | Arm C backward + knee-adaptive forward (2 remaining variants: skip-k1, margin=0.15) | 0.015 | in progress (arch-sandbox) | TBD | TBD | ~1.0-2.1 (contended, 4-way on 16 threads) | [`72663b9`](https://github.com/SimLeek/sili_peridot/commit/72663b9) | `research/dense-vs-sparse-mqar-300k` | `launch_arm_c_plus_knee_{skip_k1,margin15}.py` | Predates the LR fix too -- worth rerunning at peak_lr~=0.01 once these finish/are judged stuck |
