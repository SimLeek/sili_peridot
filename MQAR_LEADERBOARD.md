...
| 2026-09-18 | 128 (16) | ~70k | dy_r_target + fixed absolute per-step backward count (dy_k_min=dy_k_max=64), dense=True | 0.015 | in progress (local) | TBD | TBD | TBD | [`4c378fc`](https://github.com/SimLeek/sili_peridot/commit/4c378fc) | `research/dense-vs-sparse-mqar-300k` | `launch_dy_fixed_count_width128.py` | Test 2 (redesigned, dynamic not structural) -- see width_scaling_lr_fanin_hypothesis |
