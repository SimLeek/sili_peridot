...
| 2026-09-18 | 288 (36) | ~351k | Arm C backward + knee-adaptive forward (1 remaining variant: margin=0.15) | 0.015 | in progress (arch-sandbox) | TBD | TBD | ~1.0-2.1 (contended) | [`72663b9`](https://github.com/SimLeek/sili_peridot/commit/72663b9) | `research/dense-vs-sparse-mqar-300k` | `launch_arm_c_plus_knee_margin15.py` | Predates the LR fix too -- worth rerunning at peak_lr~=0.01 once it finishes/is judged stuck |
